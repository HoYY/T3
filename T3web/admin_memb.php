...
<script>
 $(document).ready(function(){
  ...
  function del()
  {
    document.getElementById('aa').setAttribute("action", "./delete_m.php");
          ...
          <div class="navigation">
            <nav>
              <ul class="sf-menu">
                ...
                <li class="current"><a href="./admin_memb.php">member</a></li>
  ...
  <section class="content">
    <div class="container" style="height:80vh;">
        ...
        <table class='type02' style="text-align:center; margin:5% 0 0 0;">
            ...
            <?php
            //2단조인
            $query = "select member_id, password, member_name, phone_number, member.company_name, company.company_phonenumber as company_phonenumber from member, company 
                    where member.company_name = company.company_name";
            $result = oci_parse($conn, $query);
            oci_execute($result);
            for($i=0;$array = oci_fetch_array($result);$i++)
            {
                echo "
                <tr>
                <td><input type='checkbox' id='cb".$i."' name='checkinfo[]' value='".$array[MEMBER_ID]."'><label for='cb".$i."'></label></td>
                <td>".
                $array[MEMBER_ID]."
                </td>
                <td>".
